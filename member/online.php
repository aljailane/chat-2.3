...
<div class='b_head'>المتصلون الان</div>";
$recent=date("U")-900;
...
<div class='user-info'><ul><li>$img <a href='../profile.php?uid=$uid'>$username</a><br><a href='../mail/compose.php?rname=$username'>ارسال رسالة</a></li></ul></div>"; } if($currentpage>1)
{ echo" <a href='$self?currentpage=1'>[<b>First</b>]</a> "; $prevpage=$currentpage-1;
echo" <a href='$self?currentpage=$prevpage'>[<b>السابق</b>]</a> ";
} for($x=($currentpage-$range); $x<(($currentpage+$range)+1); $x++)
{ if(($x>0) &&($x<=$totalpages)) { if($x==$currentpage) { echo" [<font color='red'>$x</font>] "; } else { echo" <a href='$self?currentpage=$x'>[<b>$x</b>]</a> "; } } }
if($currentpage!=$totalpages)
{ $nextpage=$currentpage+1;
echo"<a href='$self?currentpage=$nextpage'>[<b>التالي</b>]</a>";
echo"<a href='$self?currentpage=$totalpages'>[<b>الاخبر</b>]</a>"; } } echo"<br><div class='link_button'><a href='index.php'>رجوع</div></a>";
include "../footer.php";
?>
