...
--></style><div class="grid3 middle" align="center">تعيين حالتك ستظهر بالغرف والموقع <form action="#" method="post"><p><li><center><input type="text" name="status" value="<?php echo $status; ?>"></li><li><center><input type="submit" name="update" value="تحديث حالتگ" class="button"></center></li></ul></p><div class="error_message"></div>
