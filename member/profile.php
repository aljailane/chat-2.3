...
if($onlinecheck>0) {
$st="<font color='green'>.::متصل::.</font>"; } else { $st="<font color='red'>.::غير متصل::.</font>"; } echo "<title>$config->title &raquo; $username's profile</title>";
echo"<div class='breadcrumb'></div>
<center>"; include "ads.php";
fblike(); echo"</center>
<div style='margin-top: 5px;' class='grid3'></div>";
echo"<div class='grid3 middle' align='center'><div class='b_head'>$username ملف</div>$st<br/>$status"; if(empty($avatar)) { $avatar="/images/nophoto.png"; } else { $avatar="/avatars/$avatar";
