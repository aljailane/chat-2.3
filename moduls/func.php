...
$symbol = 'د'; // symbol of currency leave empty for nothing.
...
$string = preg_replace("/\[img=(.+?)\]\[\/img\]/", '<img src="$1">', $string);
$string = preg_replace("#\[code\](.*?)\[/code\]#si", "<div class='code2'>كود:<div class='code2'><font color=blue>$1</font></div></div><br/>",$string);
$string=nl2br($string);
return $string;
}
...
'شات'=>"عفوا رسالتگ مشفرة",
'س1'=>"وردة سلام عليكم ورحمة الله وبركاته وردة",
'س2'=>"عليگم السلام ورحمة اللة وبرگاااته",
'باك'=>"بـــآآآگ",
'كيفك'=>"گــيفگ",
'هع'=>"<img src='$config->url/icons/ah.gif' alt='هع'/>",
'وردة'=>"<img src='$config->url/icons/ward.gif' alt='وردة'/>",
'ضرب'=>"<img src='$config->url/icons/drb.gif' alt='ضرب'/>",
'نايس'=>"<img src='$config->url/icons/nic.gif' alt='نايس'/>",
'رفص'=>"<img src='$config->url/icons/rafs.gif' alt='رفص'/>",
'بوسة'=>"<img src='$config->url/icons/busa.gif' alt='بوسة'/>",
'بفكر'=>"<img src='$config->url/icons/fkr.gif' alt='بفكر'/>",
...
'ياي'=>"<img src='$config->url/addons/smileys/lol.png' alt='هع' />",
