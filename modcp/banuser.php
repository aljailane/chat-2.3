...
echo"<ul><li>[$i] $st$username<br/><a href='?action=Delete&yes=true&id=$id'>Ban</a></li></ul>";
...
{ $id=(int)$_GET["id"];
$query=mysql_query("UPDATE b_users SET ban='1' WHERE userID=$id");
if($query)
{
$msg="User Banned Successfuly";
}
else
{
$msg=mysql_error();
